...
class ConfigTests(unittest.TestCase):
    ...
    def test_example_config_loads_nested_values(self) -> None:
        ...
        self.assertEqual(config.audio.device, 1)
        self.assertEqual(config.audio.wake_stream_channel, 1)
        self.assertEqual(config.audio.input_gain_db, 0.0)
        self.assertEqual(config.wake_ack.playback_device, 4)
        self.assertEqual(config.tts.playback_device, 4)
    ...
    def test_demo_configs_load(self) -> None:
        ...
        self.assertEqual(mock_config.audio.device, 1)
        ...
        self.assertEqual(mify_config.audio.device, 1)
        ...
        self.assertEqual(mify_config.tts.playback_device, 4)
        ...
        self.assertEqual(wake_config.wake_ack.playback_device, 4)
        self.assertEqual(wake_config.audio.device, 1)
        ...
        self.assertEqual(wake_config.tts.playback_device, 4)
        ...
        self.assertEqual(local_tts_config.tts.playback_device, 4)
        ...
        self.assertEqual(aliyun_tts_config.audio.device, 1)
        self.assertEqual(aliyun_tts_config.tts.playback_device, 4)
        self.assertEqual(
        ...
        self.assertEqual(aliyun_wake_config.audio.device, 1)
        ...
        self.assertEqual(aliyun_wake_config.wake_ack.playback_device, 4)
        ...
        self.assertEqual(aliyun_wake_config.tts.playback_device, 4)
