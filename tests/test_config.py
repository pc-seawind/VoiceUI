...
LINUX_XVF_DEVICE = "reSpeaker XVF3800 4-Mic Array: USB Audio"
...
class ConfigTests(unittest.TestCase):
    def test_default_config_uses_nested_dataclasses(self) -> None:
        ...
        self.assertTrue(config.conversation.voice_termination_enabled)
        self.assertIn("停止", config.conversation.voice_termination_phrases)
        ...
        self.assertEqual(config.conversation.post_tts_wake_cooldown_seconds, 0.0)
    ...
    def test_linux_wake_aliyun_config_uses_openwakeword_and_aliyun_backends(self) -> None:
        ...
        self.assertEqual(config.conversation.post_tts_wake_cooldown_seconds, 1.2)
