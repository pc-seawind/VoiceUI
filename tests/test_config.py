...
class ConfigTests(unittest.TestCase):
    ...
    def test_mify_config_loads_backend_values(self) -> None:
        ...
        self.assertEqual(config.llm.api_key_env, "DASHSCOPE_API_KEY")
    ...
    def test_demo_configs_load(self) -> None:
        ...
        self.assertEqual(mify_config.llm.api_key_env, "DASHSCOPE_API_KEY")
        ...
        self.assertEqual(aliyun_wake_config.llm.api_key_env, "DASHSCOPE_API_KEY")
