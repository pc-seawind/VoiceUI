...
LOG_SPECS: tuple[LogSpec, ...] = (
    ...
    LogSpec("llm.warm_up_error", "event", "llm", "warm_up_error"),
    LogSpec("llm.warmed_up", "event", "llm", "warmed_up"),
    LogSpec("llm.stream_completed", "event", "llm", "stream_completed"),
    LogSpec("miot.resolver", "event", "miot", "resolver"),
    LogSpec("miot.scheduled", "event", "miot", "scheduled"),
    ...
    LogSpec("reminder.cancelled", "event", "reminder", "cancelled"),
    LogSpec("reminder.completed", "event", "reminder", "completed"),
    LogSpec("reminder.failed", "event", "reminder", "failed"),
    LogSpec("reminder.scheduled", "event", "reminder", "scheduled"),
    LogSpec("reminder.triggered", "event", "reminder", "triggered"),
    ...
    LogSpec("stt.aliyun_token_refreshed", "event", "stt", "aliyun_token_refreshed"),
    LogSpec("stt.streaming_empty_fallback", "event", "stt", "streaming_empty_fallback"),
    ...
    LogSpec("stt.warm_up_error", "event", "stt", "warm_up_error"),
    ...
    LogSpec("tts.warm_up_error", "event", "tts", "warm_up_error"),
    LogSpec("tts.warmed_up", "event", "tts", "warmed_up"),
    ...
    LogSpec("wake.audio_saved", "event", "wake", "audio_saved"),
